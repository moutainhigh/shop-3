 ...
 * jqsl2012@163.com
 */
package net.jeeshop.web.action.manage.indexFloor;
 ...
 * 
 */
public class IndexFloorAction extends BaseAction<IndexFloor> {
	...
	public void prepare() throws Exception {
		if (this.e == null) {
			this.e = new IndexFloor();
		}
	}

	@Override
	public void insertAfter(IndexFloor e) {
		e.clear();
	}
	...
	protected void selectListAfter() {
		pager.setPagerUrl("indexFloor!selectList.action");
	}
	@Override
...
//		uploadImage();
	...
	private void uploadImage() throws IOException{
		...
		String realpath = ServletActionContext.getServletContext().getRealPath("/indexFloor/");
...
//		String url = sInfo.getWww_ip() + "/file/img/" + imageName;
		String url = "/indexFloor/" + imageName;
		e.setPicture(url);
		image = null;
	}
