		...
		<div id="contians_div" style="text-align: right; border: 0px solid red; margin: auto;">
			<div id="context_div" style="margin-top: 20px;">
				...
				<table id="result_table2" class="table table-bordered"
					...
					<tr>
						<td style="text-align: center;" colspan="2"><input type="button" id="add" value="修改或添加" class="btn btn-primary" /></td>
					</tr>
				</table>
			</div>
		</div>
