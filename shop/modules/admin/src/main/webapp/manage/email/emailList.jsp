	...
	<s:form action="email!selectList.action" namespace="/manage" method="post" theme="simple">
		<table class="table table-bordered">
			<tr>
				...
				<td style="text-align: left;"><s:textfield name="e.accountId" cssClass="search-query input-small"
						id="accountId" /></td>
...
<!-- 				<th style="width: 115px;">操作</th> -->
			...
			<s:iterator value="pager.list">
				<tr>
					...
					<td nowrap="nowrap">&nbsp;
						<s:a target="_blank" href="accountId!show.action?accountId=%{accountId}"><s:property value="accountId" />
						</s:a>
					</td>
					<td nowrap="nowrap">&nbsp;
