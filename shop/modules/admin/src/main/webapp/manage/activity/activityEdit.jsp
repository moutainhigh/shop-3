...
<%@page import="com.tuisitang.modules.shop.entity.AccountRank"%>
	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<td style="text-align: left;" class="dfsfdsfsf" id="checkboxArr">
				...
				<label for="e.accountRange-2" class="checkboxLabel">黄金会员</label>
				<input type="checkbox" name="e.accountRange" value="R3" id="e.accountRange-3">
				<label for="e.accountRange-3" class="checkboxLabel">白金会员</label>
				<input type="checkbox" name="e.accountRange" value="R4" id="e.accountRange-4">
				<label for="e.accountRange-4" class="checkboxLabel">钻石会员</label>
