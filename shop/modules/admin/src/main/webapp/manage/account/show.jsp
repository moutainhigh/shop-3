	...
	<div id="tabs-1">
		...
		<table class="table table-bordered">
					...
					<tr>
						...
						<td style="text-align: left;"><s:property value="e.mobile"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="text-align: left;"><fmt:formatDate value="${e.lastLoginTime }" pattern="yyyy-MM-dd hh:mm:ss"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="text-align: left;"><fmt:formatDate value="${e.regeistDate }" pattern="yyyy-MM-dd hh:mm:ss"/></td>
					</tr>
					<tr>
