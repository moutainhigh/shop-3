	...
	<s:form action="account!selectList" namespace="/manage" method="post" theme="simple">
		<table class="table table-bordered">
			<tr>
				...
				<td style="text-align: left;"><s:textfield name="e.mobile" cssClass="input-medium"
						id="mobile" /></td>
				<td style="text-align: right;" nowrap="nowrap">账号</td>
				<td style="text-align: left;"><s:textfield name="e.account" cssClass="input-medium"
						id="account" /></td>
			...
			<tr>
				<td colspan="28">
					<a class="btn btn-primary" href="account!toEdit.action"><i class="icon-add icon-white"></i> 新增</a>
		...
		<table class="table table-bordered table-hover">
			<tr style="background-color: #dff0d8">
				...
				<th nowrap="nowrap" width="90px">注册日期</th>
				<!-- <th nowrap="nowrap">最后登录时间</th>
				<th nowrap="nowrap">最后登录IP</th> -->
				<th nowrap="nowrap" width="20px">是否冻结</th>
<!-- 				<th width="150px">冻结时间</th> -->
				<th nowrap="nowrap" width="60px">操作</th>
			</tr>
			<s:iterator value="pager.list">
				<tr>
					...
					<%-- <td nowrap="nowrap" align="center">
						...
						<s:else>
							<span class="badge badge-warning">报喜了</span>
						</s:else>
					</td> --%>
					<td nowrap="nowrap">&nbsp;<s:property value="mobile" /></td>
					<td nowrap="nowrap">&nbsp;<s:property value="account" /></td>
					<td nowrap="nowrap">&nbsp;<s:property value="nickname" /></td>
					<td nowrap="nowrap">&nbsp;<s:property value="rankName" /></td>
					<td nowrap="nowrap">&nbsp;<fmt:formatDate value="${regeistDate }" pattern="yyyy-MM-dd hh:mm:ss"/></td>
