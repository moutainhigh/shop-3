...
<link rel="stylesheet" href="<%=request.getContextPath() %>/resource/select2/select2.min.css">
...
<%-- 					<td>&nbsp;<s:property value="e.remark" /></td> --%>
					...
					<td style="width: 200px;">
						...
						<s:else>
							<a class="btn" href="manage/order!selectOrdership.action?orderid=<s:property value="e.id" />" disabled="disabled" onclick="javascript:return false;">修改收货人配送信息</a>
						</s:else> --%>
					</td>
		...
		<!-- 			<td>商品编号</td> -->
				...
				<s:iterator value="e.orderdetail" status="i" var="odetail">
					<tr>
						...
						<td width="200px"><a target="_blank" style="text-decoration: underline;" href="<%=SystemManager.systemSetting.getWww()%>/product/<s:property value="productID" />"><s:property value="productName"/><br/><s:property value="specInfo"/></a></td>
						...
						<td><s:if test="e.paystatus.equals(\"y\")">
							<select name="supplierName" style="width:160px;">
						...
						<td>
							物流方式：<select name="LogisticsType" style="width:170px;"></select><br/>
							物流公司：<input type="text" name="" value="" style="width:160px;"><br/>
							物流单号：<input type="text" name="" value="" style="width:160px;"><br/>
							物流费用：<input type="number" name="" value="" style="width:160px;">
						</td>
						<td>
							物流方式：<select name="supplierName" style="width:170px;"></select><br/>
							物流公司：<input type="text" name="" value="" style="width:160px;"><br/>
							物流单号：<input type="text" name="" value="" style="width:160px;"><br/>
							物流费用：<input type="number" name="" value="" style="width:160px;">
						</td>
