	...
	<s:form action="order" namespace="/manage" method="post" theme="simple">
		<table class="table table-bordered">
			<tr>
				...
				<td>用户账号</td>
				<td><s:textfield cssClass="search-query input-small" name="e.accountId"/></td>
				<td>时间范围</td>
...
<!-- 				<th>折扣</th> -->
			...
			<s:iterator value="pager.list">
				<tr>
					...
					<td><s:a target="_blank" href="accountId!show.action?accountId=%{accountId}"><s:property value="accountId" /></s:a></td>
