	...
	<table class="table">
		<tr>
			...
			<td style="text-align: left;">
				...
				顺序<s:textfield name="e.questionnaireItem.sort" id="sort" placeholder="请输入题目顺序,必须是数字"/>
				<br>
	...
	<div id="tabs-1">
		<table class="table table-condensed">
			...
			<tr>
				...
				<td style="text-align: left;"><s:textarea name="e.subtitle" rows="3" cols="40" cssStyle="width:500px;"
