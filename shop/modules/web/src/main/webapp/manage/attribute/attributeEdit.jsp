					...
					<s:if test="#i.index==0"><!-- 第一个不能删除 -->
						<tr class="pclass">
							...
							<td style="text-align: left;">
								...
								<span style="margin-left:150px;"></span> 显示顺序：<s:textfield number="y" name="e.order1List0" id="order1List0" value="%{sort}" size="5" maxlength="5" data-rule="required;integer;order1List0;length[1~5];"/>
							</td>
						</tr>
					</s:if>
					<s:else>
						<tr class="pclass">
							...
							<td style="text-align: left;">
								...
								<span style="margin-left:150px;"></span> 显示顺序：<s:textfield number="y" name="e.order1List" id="order1List" value="%{sort}" size="5" maxlength="5" data-rule="required;integer;order1List;length[1~5];"/>
							</td>
						</tr>
					</s:else>
				</s:iterator>
