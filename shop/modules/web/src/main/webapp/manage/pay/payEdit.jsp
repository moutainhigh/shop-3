...
<%-- 					<s:select list="#{'n':'禁用','y':'启用'}" name="e.status"/> --%>
			...
			<tr>
				...
				<td style="text-align: left;"><s:textfield name="e.keyword" data-rule="商户的私钥:required;keyword;length[1~45];"  
						id="keyword" /></td>
			</tr>
			<tr>
				<td style="text-align: right;">排序</td>
				<td style="text-align: left;"><s:textfield name="e.sort" data-rule="排序:integer;sort;"   
						id="sort" /></td>
			</tr>
			<tr>
