					...
					<tr>
						...
						<td nowrap="nowrap">&nbsp;
							<s:if test="accountType.equals(\"w\")">
								<s:a target="_blank" href="accountId!show.action?accountId=%{accountId}"><s:property value="accountId" /></s:a>
							</s:if>
							<s:elseif test="accountType.equals(\"m\")">
								<s:a target="_blank" href="user!show.action?accountId=%{accountId}"><s:property value="accountId" /></s:a>
							</s:elseif>
