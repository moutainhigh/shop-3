...
public class AlipaySubmit {
	...
	//        	mysign = MD5.sign(prestr, AlipayConfig.key, AlipayConfig.input_charset);
				mysign = MD5.sign(prestr, Global.getAlipayKey(), AlipayConfig.input_charset);
	        } else if (signType.equals("RSA")) {
				mysign = RSA.sign(prestr, Global.getAlipayPrivateKey(), AlipayConfig.input_charset);
	        }
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName, String strParaFileName, String signType) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp, signType);
        List<String> keys = new ArrayList<String>(sPara.keySet());
     ...
     * @throws Exception
     */
    public static String buildRequest(String strParaFileName, String strFilePath,Map<String, String> sParaTemp, String signType) throws Exception {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp, signType);
...
//        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayConfig.partner + "&_input_charset" +AlipayConfig.input_charset;
		String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner="
				+ Global.getAlipayPartner() + "&_input_charset"
