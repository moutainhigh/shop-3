...
public class Oauth {
    ...
    public Oauth() {
        super();
        this.appid = Global.getConfig("AppId");
        this.secret = Global.getConfig("AppSecret");
    }
