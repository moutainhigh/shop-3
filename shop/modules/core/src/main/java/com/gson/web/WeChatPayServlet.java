...
public class WeChatPayServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if (isweixin) {
			...
			String packagestring = WxPay.getPackage(params); //对参数打包
			String paySign = WxPay.paySign(timeStamp, "", nonceStr, packagestring); // 构造签名
			
			// appId
			req.setAttribute("appid", Global.getConfig("AppId"));
			// timeStamp
