...
public class SystemManager {
	...
	public static Map<Long,Attribute> attrsMap = new HashMap<Long, Attribute>();//属性集合map
...
//	public static Map<Integer, Integer> catalogMap = new HashMap<Integer, Integer>();//目录表，key:目录ID，value:目录顶级PID
	...
	public static ConcurrentMap<Long, ProductStockInfo> productStockMap;// = new ConcurrentHashMap<String, ProductStockInfo>();//商品库存表
...
//	public static Map<String,News> newsMap = new HashMap<String, News>();//文章map；key:code
	...
	public static Area topArea;//省市区集合
	...
	public static QiniuOSS qiniuOSS;//七牛存储的配置信息
//	public static Task task;//系统定时任务
	public static List<Product> indexLeftProduct;//加载首页左侧的商品列表，此位置的商品从全局加载
	public static Map<Long,Activity> activityMap = new HashMap<Long, Activity>();//所有活动列表
