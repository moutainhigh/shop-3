...
//	public static String show_user_option_error = "show_user_option_error";//显示用户操作错误信息，error.jsp页面会显示session中该key指定的错误信息，显示后会同时清除该错误信息。
	...
	public static final String PRODUCT_IMAGES_SPLIDER = ",";//商品图片分割符
	...
	public static final String PRODUCT_FAVORITE_COOKIE_KEY = "PRODUCT_FAVORITE_COOKIE_KEY";//所有的非法请求全部抛出此错误
