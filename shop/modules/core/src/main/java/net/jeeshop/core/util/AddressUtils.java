...
//			System.out.println("isp="+isp);
	...
	public static void main(String[] args) {
		...
		String url = "http://ip.taobao.com/service/getIpInfo.php?ip=125.71.211.185";
		try {
			String json = HttpKit.post(url, new HashMap<String,String>());
			System.out.println(json);
			JsonMapper mapper = JsonMapper.getInstance();
			System.out.println(mapper.fromJson(json, Map.class));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
