...
<html> 
  <head> 
    ...
    <link rel="stylesheet" type="text/css" href="${ctxAssets }/stylesheets/animate.min.css">
    <link rel="stylesheet" type="text/css" href="${ctxAssets }/stylesheets/donghua.css">
    <sitemesh:head/>
  </head>
  <body>
  <div class="animate">
        <div class="animate-main">
            <div class="close-btn">
                <img src="${ctxAssets}/image/donghua-close.png">
            </div>
            <div class="background1">
                <img src="${ctxAssets}/image/background1.png">
            </div>
            <div class="background2">
                <img src="${ctxAssets}/image/background2.png">
            </div>
            <div class="background3">
                <img src="${ctxAssets}/image/background3.png">
            </div>
            <div class="person-left">
                <img src="${ctxAssets}/image/person-left1.png" class="left1">
                <img src="${ctxAssets}/image/person-left2.png" class="left2">
                <img src="${ctxAssets}/image/person-left3.png" class="left3">
            </div>
            <div class="person-right">
                <img src="${ctxAssets}/image/person-right1.png" class="right1">
                <img src="${ctxAssets}/image/person-right2.png" class="right2">
                <img src="${ctxAssets}/image/person-right3.png" class="right3">
            </div>
            <div class="left-word">
                <img src="${ctxAssets}/image/left-word1.png">
            </div>
            <div class="right-word">
                <img src="${ctxAssets}/image/right-word1.png">
            </div>
            <div class="together-word">
                <img src="${ctxAssets}/image/together1.png" class="together1">
                <img src="${ctxAssets}/image/together2.png" class="together2">
            </div>
        </div>
  ...
  <script type="text/javascript" src="${ctxAssetsJS }/javascripts/donghua.js"></script>
