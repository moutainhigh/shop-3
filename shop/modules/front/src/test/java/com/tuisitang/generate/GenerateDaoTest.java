...
public class GenerateDaoTest {
	...
	private static Logger logger = LoggerFactory.getLogger(GenerateDaoTest.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.tuisitang.modules";

		String moduleName = "shop"; // 模块名，例：sys
		String className = "Hotquery"; // 类名，例：user
		...
		String filePath = javaPath + separator + model.get("moduleName") + separator + "dao" + separator  
				+ model.get("ClassName") + "DaoTest.java";
