 ...
 */
package com.tuisitang.projects.pm.modules.sys.security;
...
import com.tuisitang.projects.pm.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		if (user != null) {
			...
			SpringContextHolder.publishEvent(new LoginEvent(this, user, principal, requestMap));
