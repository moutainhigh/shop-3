...
public class ProductPriceAnalyzeServiceTest extends SpringTransactionalContextTests {
	...
	public void analyze() {
		...
		// List<Product> list =
		// productService.findProduct(61L,591L,593L,572L,1387L,1388L,1389L);
		...
		for (final Product product : list) {
			...
			if (psList.isEmpty()) {
				...
				addCell(row, 1, name, 0, String.class, styles);
				addCell(row, 2, "", 0, String.class, styles);
				addCell(row, 3, activity, 0, String.class, styles);
				addCell(row, 4, product.getUnit(), 0, String.class, styles);
				addCell(row, 5, min, 0, Integer.class, styles);
				addCell(row, 6, df.format(factoryPrice), 0, String.class, styles);
				addCell(row, 7, df.format(price), 0, String.class, styles);
				addCell(row, 8, df.format(expressPrice), 0, String.class, styles);
				addCell(row, 9, rate, 0, String.class, styles);
			} else {
...
//					double expressPrice = product.getExpressPrice();
					...
					addCell(row, 0, id, 0, id.getClass(), styles);
					addCell(row, 1, name, 0, String.class, styles);
					addCell(row, 2, spec, 0, String.class, styles);
					addCell(row, 3, activity, 0, String.class, styles);
					addCell(row, 4, product.getUnit(), 0, String.class, styles);
					addCell(row, 5, min, 0, Integer.class, styles);
					addCell(row, 6, df.format(factoryPrice), 0, String.class, styles);
...
//			logger.info("出厂价 {} 出售价 {} 物流费 {} 利润率 {}", factoryPrice, price, expressPrice, rate);
		}
